...
// Contact Form 		
	$('#send').click(function(){ // when the button is clicked the code executes
		...
		var firstName = $('input#insightly_firstName').val(); // get the value of the input field
		if(firstName == "" || firstName == " " || firstName == "Name") {
    $('#err-first-name').show(500);
    $('#err-first-name').delay(4000);
    $('#err-first-name').animate({
      height: 'toggle'  
    }, 500, function() {
      // Animation complete.
    }); 
    ...
    var lastName = $('input#insightly_lastName').val(); // get the value of the input field
    if(lastName == "" || lastName == " " || lastName == "Name") {
      $('#err-last-name').show(500);
      $('#err-last-name').delay(4000);
      $('#err-last-name').animate({
        height: 'toggle'
      }, 500, function() {
        // Animation complete.
      });
